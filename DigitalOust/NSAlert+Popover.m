...
// Property Self (self retaining)
- (void) retainSelf {
    objc_setAssociatedObject(self, &SELF_KEY, self, OBJC_ASSOCIATION_RETAIN);
}

- (void) releaseSelf {
    objc_setAssociatedObject(self, &SELF_KEY, nil,  OBJC_ASSOCIATION_RETAIN);
}
